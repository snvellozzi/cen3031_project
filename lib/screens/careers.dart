class Careers {
  ...
  static List<Careers> getCareers() =>  [
    ...
    Careers("Journalism", "News Journalist", "A Journalist, or Reporter, is responsible for researching and writing informational news articles and stories about real events using a fair and unbiased perspective.",
    ...
    Careers("Biology", "Biologist", "Biologists study organisms and plant life to learn more about their composition, behaviors, habitats, and how they interact with other organisms and their environment.",
    ...
    Careers("Biology", "Biology Teacher", "The biology teacher's responsibilities include preparing lesson plans, tests and assignments, supervising students during investigations and experiments, and acting as a field trip chaperone.",
        "\$55,094 per year", "Bachelor's (4 years)", "Develop and initiate biology teaching materials and course content; deliver lectures to students on living organisms and things; teach students on how cells function in relation to their environments; teach and encourage students to conduct experiments in biology."),

    Careers("Business", "Accountant", "An Accountant helps businesses make critical financial decisions by collecting, tracking, and correcting the company's finances.",
        "\$53,973 per year", "Bachelor's (4 years)", "Perform financial audits; reconciling bank statements; ensuring financial records are accurate throughout the year."),
    ...
    Careers("Psychology", "Psychologist", "Psychologists study cognitive, emotional, and social processes and behavior by observing, interpreting, and recording how individuals relate to one another and to their environments.",
    ...
    Careers("Engineering", "R&D Engineer", "As R&D Engineer, you will be responsible for developing and improving a wide range of production processes.",
    ...
    Careers("Education", "Education Administration", "An educational administrator ensures a safe and productive learning environment for the students and faculty at their institution.",
    ...
    Careers("Law/Political Science", "Lawyer", "Lawyers, also known as attorneys, are certified professionals who advise and represent natural and juristic persons in legal matters.",
    ...
    Careers("Art/Design", "Illustrator", "As an illustrator, you'll work to commercial briefs to inform, persuade or entertain a client's intended audience, adjusting the mood and style of images accordingly.",
    ...
    Careers("Math/Statistics", "Actuary", "Actuaries analyze the financial costs of risk and uncertainty.",
